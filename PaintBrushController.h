...
#ifndef __GEL__PaintBrushController__
#define __GEL__PaintBrushController__
...
class PaintBrushController : public UtensilController
{
...
public:
    PaintBrushController(cWorld *newWorld, cMesh *newCanvas, string newResourceRoot, shared_ptr<cGenericHapticDevice> newHapticDevice);
    virtual void updateHaptics(double time, cVector3d position, double deviceForceScale);
    virtual void updateGraphics();
    
};

#endif /* defined(__GEL__PaintBrushController__) */
