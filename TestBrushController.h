...
#ifndef __GEL__TestBrushController__
#define __GEL__TestBrushController__
...
class TestBrushController : public UtensilController
{
...
public:
    TestBrushController(cWorld *newWorld, cMesh *newCanvas, string newResourceRoot, shared_ptr<cGenericHapticDevice> newHapticDevice);
    virtual void updateHaptics(double time, cVector3d position, double deviceForceScale);
    virtual void updateGraphics();
    
};

#endif /* defined(__GEL__TestBrushController__) */
