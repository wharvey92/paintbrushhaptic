...
SmallBrushController::SmallBrushController(cWorld *newWorld, cMesh *newCanvas, string resourceRoot, shared_ptr<cGenericHapticDevice>newHapticDevice)  : UtensilController(newWorld, newCanvas, resourceRoot, newHapticDevice) {
...
cVector3d SmallBrushController::calculateForces(cVector3d currSpherePos, cVector3d fixedSphere, double sprCons, cVector3d velocity, double sprLength, bool lengthOn) {
...
void SmallBrushController::updateHaptics(double time, cVector3d position, double deviceForceScale) {
...
void SmallBrushController::updateGraphics() {
