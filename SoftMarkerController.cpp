...
SoftMarkerController::SoftMarkerController(cWorld *newWorld, cMesh *newCanvas, string resourceRoot, shared_ptr<cGenericHapticDevice>newHapticDevice)  : UtensilController(newWorld, newCanvas, resourceRoot, newHapticDevice) {
...
cVector3d SoftMarkerController::calculateForces(cVector3d currSpherePos, cVector3d fixedSphere, double sprCons, cVector3d velocity, double sprLength, bool lengthOn) {
...
void SoftMarkerController::updateHaptics(double time, cVector3d position, double deviceForceScale) {
...
void SoftMarkerController::updateGraphics() {
