...
TestBrushController::TestBrushController(cWorld *newWorld, cMesh *newCanvas, string resourceRoot, shared_ptr<cGenericHapticDevice>newHapticDevice)  : UtensilController(newWorld, newCanvas, resourceRoot, newHapticDevice) {
...
cVector3d TestBrushController::calculateForces(cVector3d currSpherePos, cVector3d fixedSphere, double sprCons, cVector3d velocity, double sprLength, bool lengthOn) {
...
void TestBrushController::updateHaptics(double time, cVector3d position, double deviceForceScale) {
...
void TestBrushController::updateGraphics() {
